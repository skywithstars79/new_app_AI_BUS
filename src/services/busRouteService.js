...
export function getRouteInformation(userLat, userLng, destinationHeritage) {
  ...
  if (dist <= 2.0) {
    ...
    return {
      ...
      kakaoMapUrl: `https://map.kakao.com/link/route/내위치,${userLat},${userLng},${encodeURIComponent(destinationHeritage.name)},${destLat},${destLng}`,
      kakaoNaviUrl: `https://map.kakao.com/link/route/내위치,${userLat},${userLng},${encodeURIComponent(destinationHeritage.name)},${destLat},${destLng}`
    };
  } 
