...
export function getRouteInformation(userLat, userLng, destinationHeritage) {
  ...
  if (dist <= 2.0) {
    ...
    return {
      ...
      kakaoMapUrl: `https://map.kakao.com/link/to/${encodeURIComponent(destinationHeritage.address || destinationHeritage.name)},${destLat},${destLng}`,
      kakaoNaviUrl: `https://map.kakao.com/link/to/${encodeURIComponent(destinationHeritage.address || destinationHeritage.name)},${destLat},${destLng}`
    };
  } 
